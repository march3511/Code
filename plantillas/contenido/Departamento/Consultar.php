...
<script type="text/javascript" src="../../plantilla/assets_propietarios/js/js-departamento.js"></script>
...
<body>	
	...
	<div id="page-wrapper">
		<div class="container-fluid">
			<div class="row">
				<div class="col-lg-12">
					<h1 class="page-header">Consulta Departamentos</h1>
							...
							<div class="filtro content">
								<form id="frm_filtro" method="post" action="">
									...
									<select name="opc" id="" class="form-control" style="width:140px;display:inline;" >
										...
										<option value="cod_dpto">Codigo</option>
													...
													<div class="table-responsive">
														<div class="tableContainer">
															<table cellpadding="0" cellspacing="0" id="data" class="table table-bordered table-hover table-striped">
																...
																<thead>
																	<tr>                              
																		<th width="20%"><span title="cod_dpto">Codigo Compañia</span></th>
