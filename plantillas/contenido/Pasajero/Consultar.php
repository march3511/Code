...
<script type="text/javascript" src="../../plantilla/assets_propietarios/js/js-pasajeros.js"></script>
...
<body>	
	...
	<div id="page-wrapper">
		<div class="container-fluid">
			<div class="row">
				<div class="col-lg-12">
					<h1 class="page-header">Consulta Pasajeros</h1>
													...
													<div class="table-responsive">
														<div class="tableContainer">
															<table cellpadding="0" cellspacing="0" id="data" class="table table-bordered table-hover table-striped">
																...
																<thead>
																	<tr>                                 
																		<th width="5%"><span title="cedula">Cedula</span></th> 
																		<th width="5%"><span title="nombres">Nombre</span></th> 
																		<th width="5%"><span title="apellidos">Apellido</span></th> 
																		<th width="5%"><span title="direccion">Direccion</span></th> 
																		<th width="5%"><span title="telefono">Telefono</span></th> 
																		<th width="5%"><span title="email">Email</span></th> 
																		<th width="5%"><span title="sexo">Sexo</span></th> 
																		<th width="5%"><span title="usuario">Usuario</span></th> 
