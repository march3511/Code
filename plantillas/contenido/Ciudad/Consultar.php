...
<script type="text/javascript" src="../../plantilla/assets_propietarios/js/js-ciudad.js"></script>
...
<body>	
	...
	<div id="page-wrapper">
		<div class="container-fluid">
			<div class="row">
				<div class="col-lg-12">
					<h1 class="page-header">Consulta Ciudades</h1>
							...
							<div class="filtro content">
								<form id="frm_filtro" method="post" action="">
									...
									<select name="opc" id="" class="form-control" style="width:140px;display:inline;" >
										...
										<option value="cod_ciudad">Codigo Ciudad</option>
										<option value="nombre">Nombre</option>
										<option value="d.nombre">Departamento</option>                      
									</select>
													...
													<div class="table-responsive">
														<div class="tableContainer">
															<table cellpadding="0" cellspacing="0" id="data" class="table table-bordered table-hover table-striped">
																...
																<thead>
																	<tr>                                  
																		<th width="20%"><span title="cod_ciudad">Codigo Ciudad</span></th>
																		<th width="25%"><span title="nombre">Nombre</span></th>
																		<th width="25%"><span title="cod_dept">Departamento</span></th>
