...
<script type="text/javascript" src="../../plantilla/assets_propietarios/js/js-aviones.js"></script>
...
<body>	
	...
	<div id="page-wrapper">
		<div class="container-fluid">
			<div class="row">
				<div class="col-lg-12">
					<h1 class="page-header">Consulta Aviones</h1>
							...
							<div class="filtro content">
								<form id="frm_filtro" method="post" action="">
									...
									<select name="opc" id="" class="form-control" style="width:140px;display:inline;" >
										...
										<option value="cod_avion">Codigo Avion</option>
										<option value="tipo">Tipo</option>
										<option value="cod_compania">Compañia</option>  
													...
													<div class="table-responsive">
														<div class="tableContainer">
															<table cellpadding="0" cellspacing="0" id="data" class="table table-bordered table-hover table-striped">
																...
																<thead>
																	<tr>                                 
																		<th width="10%"><span title="cod_avion">Codigo Avion</span></th>
																		<th width="15%"><span title="tipo">Tipo</span></th>
																		<th width="10%"><span title="modelo">Modelo</span></th>
																		<th width="30%"><span title="cod_compania">Compañia</span></th>
